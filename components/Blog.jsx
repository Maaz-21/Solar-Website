...
const FALLBACK_IMAGE =
  "https://images.unsplash.com/photo-1508514177221-188b1cf2f26f?q=80&w=2070&auto=format&fit=crop";
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4">
                  <Link href={post.slug} className="text-sm text-primary font-semibold inline-flex items-center group/link">
